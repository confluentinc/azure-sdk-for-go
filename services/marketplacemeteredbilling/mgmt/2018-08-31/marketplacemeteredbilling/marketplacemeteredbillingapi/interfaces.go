...
import (
    ...
    "github.com/Azure/azure-sdk-for-go/services/marketplacemeteredbilling/mgmt/2018-08-31/marketplacemeteredbilling"
        ...
        type ClientAPI interface {
            BatchUsageEvent(ctx context.Context, authorization string, parameters marketplacemeteredbilling.BatchUsageEventRequest) (result marketplacemeteredbilling.SetObject, err error)
