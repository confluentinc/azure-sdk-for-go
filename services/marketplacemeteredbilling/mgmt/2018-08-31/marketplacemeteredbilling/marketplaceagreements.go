...
// MarketplaceAgreementsClient is the REST API for MarketplaceMeteredBilling.
...
func (client MarketplaceAgreementsClient) Cancel(ctx context.Context, publisherID string, offerID string, planID string) (result AgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Cancel", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Cancel", resp, "Failure sending request")
            return
            }

            result, err = client.CancelResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Cancel", resp, "Failure responding to request")
            }
    ...
    autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceMeteredBilling/agreements/{publisherId}/offers/{offerId}/plans/{planId}/cancel",pathParameters),
...
func (client MarketplaceAgreementsClient) Create(ctx context.Context, publisherID string, offerID string, planID string, parameters AgreementTerms) (result AgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Create", nil , "Failure preparing request")
    return
    }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Create", resp, "Failure sending request")
            return
            }

            result, err = client.CreateResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Create", resp, "Failure responding to request")
            }
    ...
    autorest.AsPut(),
    autorest.WithBaseURL(client.BaseURI),
    autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceMeteredBilling/offerTypes/{offerType}/publishers/{publisherId}/offers/{offerId}/plans/{planId}/agreements/current",pathParameters),
...
func (client MarketplaceAgreementsClient) Get(ctx context.Context, publisherID string, offerID string, planID string) (result AgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Get", nil , "Failure preparing request")
    return
    }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Get", resp, "Failure sending request")
            return
            }

            result, err = client.GetResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Get", resp, "Failure responding to request")
            }
...
func (client MarketplaceAgreementsClient) GetAgreement(ctx context.Context, publisherID string, offerID string, planID string) (result AgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "GetAgreement", nil , "Failure preparing request")
    return
    }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "GetAgreement", resp, "Failure sending request")
            return
            }

            result, err = client.GetAgreementResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "GetAgreement", resp, "Failure responding to request")
            }
    ...
    autorest.AsGet(),
    autorest.WithBaseURL(client.BaseURI),
    autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceMeteredBilling/agreements/{publisherId}/offers/{offerId}/plans/{planId}",pathParameters),
    autorest.WithQueryParameters(queryParameters))
    return preparer.Prepare((&http.Request{}).WithContext(ctx))
    }
...
func (client MarketplaceAgreementsClient) List(ctx context.Context) (result ListAgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "List", nil , "Failure preparing request")
    return
    }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "List", resp, "Failure sending request")
            return
            }

            result, err = client.ListResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "List", resp, "Failure responding to request")
            }
    ...
    autorest.AsGet(),
    autorest.WithBaseURL(client.BaseURI),
    autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceMeteredBilling/agreements",pathParameters),
    autorest.WithQueryParameters(queryParameters))
    return preparer.Prepare((&http.Request{}).WithContext(ctx))
    }
...
func (client MarketplaceAgreementsClient) Sign(ctx context.Context, publisherID string, offerID string, planID string) (result AgreementTerms, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Sign", nil , "Failure preparing request")
    return
    }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Sign", resp, "Failure sending request")
            return
            }

            result, err = client.SignResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "marketplacemeteredbilling.MarketplaceAgreementsClient", "Sign", resp, "Failure responding to request")
            }
    ...
    autorest.AsPost(),
    autorest.WithBaseURL(client.BaseURI),
    autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.MarketplaceMeteredBilling/agreements/{publisherId}/offers/{offerId}/plans/{planId}/sign",pathParameters),
    autorest.WithQueryParameters(queryParameters))
    return preparer.Prepare((&http.Request{}).WithContext(ctx))
    }
