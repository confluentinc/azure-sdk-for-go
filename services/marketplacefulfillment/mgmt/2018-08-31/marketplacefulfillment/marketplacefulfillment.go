...
func NewClient(authorization string) Client {
    return NewClientWithBaseURI(DefaultBaseURI, authorization)
}

// NewClientWithBaseURI creates an instance of the Client client.
    func NewClientWithBaseURI(baseURI string, authorization string) Client {
        return Client{ NewWithBaseURI(baseURI, authorization)}
    }
